            ...
            try {
                ...
                if (message["bottle"]) {
                    ...
                    if (message["bottle"]["start_kissing"]) {
                        ...
                        ObjAnimate("spr_bottle_slot_" + message["bottle"].start_kissing[1], "pos_x", 0, 0, function() {}, [ 0,0,ObjGet("spr_bottle_slot_1").pos_x, 0.25,0,412, 1.25,0,412, 1.5,0,slotPositions[slot2]['defPos'][0] ]);
