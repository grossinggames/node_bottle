        ...
        function showRatingList(rating) {
            ...
            for (var i = 0; i < rating.length; i++) {
                ...
                var ratingUser = '<a href="' + linkUserRating + '" target="_blank" class="collection-item' + active + '" style="cursor: pointer; font-size: xx-large; height: 50px;">' +
                    ...
                    '</div>' +
                    '<div id="spr_interface_modalwindow_rating_contener_user1_kiss_img" class="spr" onmousedown="" onmouseup="" onmouseover="" onmouseout="" title="" style="left: 350px; top: ' + Number(stepUserRaiting * i +3) + 'px; z-index: 2; width: 50px; height: 40px; transform: scaleX(1) scaleY(1) rotate(0deg); pointer-events: none; opacity: 1; background-position: 0px 0px; display: block; background-image: url("");">' +
                        '<img src="images/kiss_img.png" alt="" class="circle" style="height: 40px; width: 50px; border-radius: 6px;">' +
                    '</div>' +
